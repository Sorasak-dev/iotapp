            ...
            <View style={{ flexDirection: "row" }}>
              {languageOptions.map((lang) => (
                ...
                >
                  <Text
                    style={{
                      color: i18n.language === lang.code ? "blue" : "black",
                    }}
                  >
                    {lang.label}
                  </Text>
