  ...
  const settingsItems = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          title: t('Password'),
          hasArrow: true,
 полков: () => router.push("/auth/change_password"),
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          icon: (
            <Svg width="19" height="19" viewBox="0 0 19 19" fill="none">
              <Path
                d="M11.8752 1.8999V4.7499C11.8752 5.27457 12.3006 5.6999 12.8252 5.6999H15.6752M6.65025 5.6999H8.55025M6.65025 8.5499H12.3502M6.65025 11.3999H12.3502M14.2502 3.3249C13.8274 2.9466 13.3887 2.49791 13.1117 2.2065C12.9274 2.01258 12.6727 1.8999 12.4052 1.8999H5.22502C4.17569 1.8999 3.32503 2.75056 3.32502 3.79989L separar95 15.1998C3.32494 16.2492 4.1756 17.0999 5.22494 17.0999L13.775 17.0999C14.8243 17.0999 15.675 16.2493 15.675 15.1999L15.6752 5.12819C15.6752 4.88527 15.5826 4.65176 15.414 4.47688C15.1022 4.1535 14.5816 3.62139 14.2502 3.3249Z"
                stroke="#444444"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
